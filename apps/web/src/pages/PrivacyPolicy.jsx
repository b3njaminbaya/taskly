...
const SECTIONS = [
  {
    ...
    id: "collect",
    body: "We collect only what's necessary to deliver a great experience. This includes account information you provide during registration (username, email address, password hash), activity data generated as you use Teevexa Ordo (tasks created, completed, due dates), and technical data such as browser type and IP address for security purposes.",
  ...
  },
  {
    ...
    id: "use",
    body: "Your data is used exclusively to provide, secure, and improve Teevexa Ordo. Specifically: to authenticate your sessions, deliver notifications you've opted into, analyze aggregated usage to improve features, and communicate important service updates.",
  ...
  },
  {
    ...
    id: "responsibilities",
    body: "You are responsible for keeping your login credentials secure and for all activity that occurs under your account. Use a strong, unique password and enable caution when using Teevexa Ordo on shared or public devices. Notify us immediately at support@teevexa.com if you suspect unauthorized access.",
    highlight: null,
  },
  {
    Icon: Scale,
  ...
  },
  {
    ...
    id: "contact",
    body: "If you have questions, concerns, or requests regarding this Privacy Policy or how your data is handled, reach out to us at support@teevexa.com. We aim to respond to all privacy inquiries within 5 business days.",
    highlight: null,
  },
];
    ...
    <section className="bg-sidebar py-24 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center relative">
        ...
        <p className="mt-5 text-lg text-white/70 max-w-xl mx-auto leading-relaxed">
          We built Teevexa Ordo with privacy in mind. Here's exactly what data we collect, why we collect it, and how we protect it.
        </p>
      ...
      <div className="max-w-7xl mx-auto bg-primary/5 border border-primary/20 rounded-2xl p-6">
        ...
        <ul className="space-y-2">
          {[
            ...
            "Questions? Email us at support@teevexa.com — we reply within 5 business days.",
          ].map((item) => (
